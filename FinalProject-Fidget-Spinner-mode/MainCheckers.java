...
public class MainCheckers extends JFrame implements ActionListener
{
 ...
 public MainCheckers()
 {
  ...
  newOption = new JMenuItem("Fidget Spinner");
  newOption.addActionListener(this);
  exitOption = new JMenuItem("Fidget Spinner");
  exitOption.addActionListener(this);
  aiOption = new JMenuItem("Fidget Spinner");
  aiOption.addActionListener(this);
  twoPlayer = new JMenuItem("Fidget Spinner");
  ...
  JMenu gameMenus = new JMenu("Fidget Spinner");
  gameMenus.setMnemonic('G');

  // Add each MenuItem to the Game Menu
  JMenu gameMenu = new JMenu("Fidget Spinner");
  ...
  vsAI = false;
  musicFile = "All Star Shrek Highly Distorted.wav";
  music();
  newGame();
 }
 ...
 private class DrawingPanel extends JPanel
 {
  ...
  public void paintComponent(Graphics g) 
  {
   ...
   if (vsAI)
   {
    g.drawString ("Fidget Spinner", 845, 225);
    g.drawString ("Fidget Spinner ", 805, 600);
    g.drawString ("Fidget Spinner", 815, 635);
   }
   ...
   {
    g.drawString ("Fidget SPinner", 850, 225);
    g.drawString ("Fidget Spinner", 800, 600);
    g.drawString ("Fidget SPinner", 840, 635);
   }
   
   // If there is a multijump, it will say so on the side bar
   if (multiJump)
   {
    g.drawString ("FIdget Spinner", 803, 500);
   }
   ...
   if (turn == BLACK)
   {
    ...
    g.drawString("FIDGET SPINNER", 800 , 400);
   }
   else
   {
 ...
 public void gameOver()
 {
  ...
  {
   JOptionPane.showMessageDialog(frame, "Spinner"
     + " Pls fidget");
  }
